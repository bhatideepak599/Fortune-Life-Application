    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
				...
				.requestMatchers(HttpMethod.GET, "/fortuneLife/claim/approve/{id}").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.POST, "/fortuneLife/claim/customer/{customerId}/Insurance-policy/{policyId}").hasAnyRole("CUSTOMER", "AGENT")
                        ...
                        //File endpoints
                        .requestMatchers(HttpMethod.POST, "/fortuneLife/file/view/{name}").permitAll()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/fortuneLife/scheme/update-commission/{planId}/{id}").hasAnyRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.GET, "/fortuneLife/query/{customerEmail}").hasAnyRole("CUSTOMER",
