...
public class PolicyController {
    ...
    public ResponseEntity<PageResponse<CommissionDto>> getAllCommissionsOfAnAgent(
        ...
        logger.info("Fetching All The commission for the agent with ID : {}", id);
    ...
    public ResponseEntity<PageResponse<InsurancePolicyResponseDto>> getAllPoliciesUnderAnAgent(
        ...
        logger.info("Fetching All The clients of and agent with ID : {}", id);
    ...
    public ResponseEntity<InsurancePolicyResponseDto> updateDocumnets(@PathVariable(name = "id") String policyId,
        ...
        logger.info("Update rejected documents for the policy with ID : {}", policyId);
    ...
    public ResponseEntity<InsurancePolicyResponseDto> verifyPolicy(@PathVariable(name = "id") String policyId,
                                                                   @RequestBody List<SubmittedDocumentDto> documentDtos) {
        logger.info("Document verfication for policy with ID : {}", policyId);
