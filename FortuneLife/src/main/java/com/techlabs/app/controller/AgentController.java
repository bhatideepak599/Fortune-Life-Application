...
public class AgentController {
    ...
    public ResponseEntity<WithdrawalDto> claimWithdrawal(@PathVariable("agentId") Long id,
        ...
        WithdrawalDto withdrawalDto = withdrawalService.claimWithdrawal(id, amount);
    ...
    public ResponseEntity<PageResponse<WithdrawalDto>> getAllWithdrawalsOfAnAgent(@RequestParam(required = false) Long id,
                                                                                  @RequestParam(required = false) String status,
                                                                                  @RequestParam(name = "page", defaultValue = "0") int page,
                                                                                  @RequestParam(name = "size", defaultValue = "10") int size,
        ...
        PageResponse<WithdrawalDto> allWidrawals = withdrawalService.getAllWithdrawalsOfAnAgent(id,status, request, page, size);
