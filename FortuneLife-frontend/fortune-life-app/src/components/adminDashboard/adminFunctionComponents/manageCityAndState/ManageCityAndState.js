  ...
  <tbody>
        ...
        <td style={actionColumnStyles}>
          <div style={buttonGroupStyles}>
            <Button
              variant="success"
              className="me-2"
              onClick={() => handleAddCityAndState(scheme.id)}
            >
              Add City
            </Button>
            <Button
    ...
    //   style={{ maxWidth: '400px', justifyContent: 'centere'}}
      >
        ...
        <Modal.Footer style={{ display: 'flex', justifyContent: 'center' }}> {/* Center the button */}
