      ...
      <header className="header" data-header>
        <div className="container">
          <a href="#" className="logo">
            <img src="image1.jpeg" alt="Company's logo" /> {/* COMPANY'S LOGO'S IMAGE LINK */}
          </a>
          ...
          <section className="home" id="home">
            <div className="container">
              <div className="home-content">
                ...
                <p className="home-text">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
            ...
            <div className="container">
              ...
              <div className="popular-wrapper">
                <figure className="popular-banner">
                  <img src="image.jpeg" alt="Inserted Image1" /> {/* IMAGE ONE LINK */}
                </figure>
                <div className="popular-content">
                  ...
                  <h3 className="popular-content-title">Built specially for your health and loved ones</h3>
              ...
              <div className="popular-wrapper">
                <figure className="popular-banner">
                  <img src="image.jpeg" alt="Inserted Image2" /> {/* IMAGE TWO LINK */}
                </figure>
                <div className="popular-content">
                  <p className="popular-content-subtitle">
                    <ion-icon name="sparkles"></ion-icon>
                  ...
                  <h3 className="popular-content-title">We take care of you so you can stay focused on your work and family.</h3>
                  <p className="popular-content-text">Temporibus autem quibusdam et aut officiis debitis aut rerum a necessitatibus saepe eveniet ut et voluptates repudiandae sint molestiae non recusandae itaque.</p>
                  <ul className="popular-list">
                    <li className="popular-list-item">
                ...
                <li>
                  <div className="review-card">
                    <div className="review-card-content">
                      ...
                      <p className="review-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo, minima. Magni, odio eos ipsa consequatur fugit voluptatum tenetur aliquam velit?</p>
            ...
            <div className="container">
              ...
              <div className="contact-wrapper">
                <div className="contact-banner">
                  <img src="image.jpeg" alt="Image" /> {/* CONTACT IMAGE LINK */}
                </div>
                <form action="" className="contact-form">
                  <div className="form-wrapper">
                    <div className="input-wrapper">
                      <input type="text" name="name" required placeholder="Full Name" className="input-field" />
                      <ion-icon name="person"></ion-icon>
                    </div>
                    <div className="input-wrapper">
                      <input type="email" name="email" required placeholder="Email Address" className="input-field" />
                      <ion-icon name="mail"></ion-icon>
                    </div>
                  </div>
                  <textarea name="message" placeholder="Write your message..." className="input-field"></textarea>
                  <button type="submit" className="btn btn-primary">
                    Send Message
                  </button>
                </form>
        ...
        <div className="container">
          <div className="footer-wrapper">
            <div className="footer-content">
              ...
              <h2 className="h2 footer-title">Insurance Policy Is a Necessity, Not a Choice.</h2>
          ...
          <p className="footer-copyright">&copy; 2024 Fortune Life. All Rights Reserved.</p>
        </div>
      </footer>
    </div>
  );
