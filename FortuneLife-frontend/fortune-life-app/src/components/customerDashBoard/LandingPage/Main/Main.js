...
import banner from "../../../../images/Health.svg";
import "./Main.css";
import family from "../../../../images/family-svgrepo-com.svg";
import hospitalBed from "../../../../images/hospital-bed-svgrepo-com.svg";
import customerReview from "../../../../images/customer-reviews-svgrepo-com.svg";
        ...
        <article>
          ...
          <section className="popular" id="popular">
            <div className="container">
              ...
              <div className="popular-wrapper">
                <figure className="popular-banner">
                  <img src={hospitalBed} alt="Hosptalized" style={{ width: "80%" }} />
                </figure>
            ...
            <div className="container">
              ...
              <ul className="review-list">
                <li>
                  <div className="review-card">
                    <figure className="review-banner">
                      <img src={customerReview} alt="customerImg" style={{ width: "70%" }} />
                    </figure>
                    ...
                    <div className="review-meta">
                      <span>
                        ...
                        <time dateTime="2021-04-10">Date of review</time>
                      </span>

                      <span>
                        <ion-icon name="document"></ion-icon>

                        <p>Plan Opted by customer</p>
                      </span>
                    </div>

                    <h3 className="review-title">Customer1 Name</h3>
                ...
                <li>
                  <div className="review-card">
                    <figure className="review-banner">
                      <img src={customerReview} alt="customeImg" style={{ width: "70%" }} />
                    </figure>
                    ...
                    <h3 className="review-title">Customer2 Name</h3>
                ...
                <li>
                  <div className="review-card">
                    <figure className="review-banner">
                      <img src={customerReview} alt="Customer3" style={{ width: "70%" }} />
                    </figure>
                    ...
                    <div className="review-meta">
                      <span>
                        ...
                        <time dateTime={Date.now()}>Date of review</time>
                      </span>
                    ...
                    <h3 className="review-title">Customer3 Name</h3>
